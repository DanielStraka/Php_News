...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Stř 28. čen 2023, 14:36
...
INSERT INTO `author` (`id`, `email`, `password`, `name`, `surname`) VALUES
(1, '', '', 'Karel', 'Vágner'),
(2, '', '', 'Eliška', 'Mladá'),
(21, 'pepavomacka@seznam.cz', '$2y$10$5n3bsc.cbUPyB7DEbp3OU.64SGsV.boayR8FWcxu3Ru6FQxXmd7ni', 'Pepa', 'Vomáčka');
...
--
ALTER TABLE `article`
  ADD CONSTRAINT `article_ibfk_1` FOREIGN KEY (`author_id`) REFERENCES `author` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
